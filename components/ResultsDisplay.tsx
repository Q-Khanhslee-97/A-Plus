                        ...
                        <>
                           <div className="flex-1 flex flex-col justify-center space-y-4">
                              <div className="bg-slate-950/50 p-4 rounded-2xl border border-slate-800/50 space-y-3">
                                <p className="text-[9px] font-black text-slate-500 uppercase tracking-widest text-center mb-2">Điều kiện tối thiểu</p>
                                
                                <div className="flex justify-between items-center">
                                  <span className="text-xs font-bold text-slate-400">{item.data.labels?.[0]} min</span>
                                  <span className={`text-xl font-black ${levelInfo.color}`}>{minC1}</span>
                                </div>
                                <div className="w-full h-px bg-slate-800/50"></div>
                                <div className="flex justify-between items-center">
                                  <span className="text-xs font-bold text-slate-400">{item.data.labels?.[1]} min</span>
                                  <span className={`text-xl font-black ${levelInfo.color}`}>{minC2}</span>
                                </div>
                              </div>
                              <p className="text-[9px] text-slate-500 text-center italic">
                                *Điểm thành phần này thấp nhất khi thành phần kia đạt tối đa.
                              </p>
                           </div>
